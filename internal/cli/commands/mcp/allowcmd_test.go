...
// TestParseAllowCmdRefusesAPatternItCannotHonor pins that a pattern which would
// allow something other than what it reads as fails rather than allowing
// nothing, or more, quietly.
